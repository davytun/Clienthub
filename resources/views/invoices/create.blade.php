                ...
                <form method="POST" action="{{ route('invoices.store') }}" x-data="invoiceForm()">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="due_date" name="due_date" type="date" class="mt-1 block w-full" :value="old('due_date', date('Y-m-d', strtotime('+14 days')))" required />
                    ...
                    <div class="mt-8">
                                        ...
                                        <tr class="border-t border-gray-100">
                                            <td class="py-2 pr-3">
                                                <input type="text" :name="`items[${index}][description]`" x-model="item.description"
                                                    class="block w-full border-gray-300 rounded-md shadow-sm text-sm focus:ring-indigo-500 focus:border-indigo-500" placeholder="Description" required />
                                            </td>
                                            <td class="py-2 px-3">
                        ...
                        <button type="button" @click="addItem()" class="mt-3 text-sm text-indigo-600 hover:text-indigo-900 font-medium">
                            + Add line item
                        </button>
                    </div>
